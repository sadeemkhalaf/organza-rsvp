      ...
      <div className="h-screen flex flex-col justify-center w-full items-center">
        ...
        <div className="flex flex-col justify-center items-center w-3/4 md:w-1/2">
          ...
          <p className="text-lg md:text-xl text-center text-wrap">
            Find the design that fits your special event style. Share everything your guests need to
            know, such as, location, time and any announcements that matters.
          </p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-medium mb-3">Share your website invitation in 1 click</h3>
              <p className="text-gray-600">
                Through email and social apps like WhatsApp, Instagram, Facebook, and QR code.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-medium mb-3">Check your guests wishes and notes</h3>
              <p className="text-gray-600">
                Let your guests share their thoughts, special requests, and congratulations.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-medium mb-3">Track your guests responses</h3>
              <p className="text-gray-600">
                View all guest replies in real-time. Never wonder who's coming again!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold mb-8">PERSONALIZE YOUR INVITATIONS</h2>
              <p className="text-gray-600 mb-8">
                Your beloved ones will like them even more, allowing them to share the moment and
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium mb-1">Track your guests status</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium mb-1">Allow them to send notes</h3>
                    <p className="text-sm text-gray-600">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium mb-1">Scan QR codes on arrival</h3>
                    <p className="text-sm text-gray-600">
      ...
      <section className="py-16 px-6 bg-white/50">
        <div className="container mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-xl mx-auto">
            Adding your beautiful photos and artwork will always be crisp, clear, and colorful so
            your site looks stunning on every screen.
          </p>

          <p className="text-center mb-12">You can check some of our favourite photographers</p>
          ...
          <div className="flex flex-wrap justify-center gap-12">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500">@anwam</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500">@karimbenzou</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500">@haithamalshaibef</p>
            </div>
          </div>
        </div>
      </section>
