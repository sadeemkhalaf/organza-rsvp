...
export const MOCKED_EVENTS: Event[] = [
  {
    ...
    capacity: 300,
    description:
      "Join us for our annual tech conference where industry leaders share insights on the latest technological trends and innovations. Network with peers and learn from the best in the field.",
    guests: [
      {
        id: "1",
        name: "Sarah Johnson",
...
export const MOCKED_IEVENTS: IEvent[] = [
  ...
  },
  {
    ...
    attributes: {
      ...
      formDescription:
        "Explore the future of blockchain technology with industry experts.",
      paid: true,
